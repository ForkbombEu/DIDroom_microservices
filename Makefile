...
authz_server_up: MS_NAME=test_authz_server
authz_server_up: MS_URL=http://localhost:3000
authz_server_up: ncr
	./ncr -p 3000 -z ./authz_server --public-directory tests/public/authz_server & echo $$! > .test.authz_server.pid

credential_issuer_up: MS_NAME=test_credential_issuer
credential_issuer_up: MS_URL=http://localhost:3001
...
relying_party_up: MS_NAME=test_relying_party
relying_party_up: MS_URL=http://localhost:3003
